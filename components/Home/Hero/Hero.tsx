    ...
    <div className="relative h-screen flex items-center justify-center text-white overflow-hidden flex-col">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <Image 
          ...
          width={150} 
          height={150} 
          className="rounded-full border-8 border-[#0c0c48aa] aspect-square object-cover" 
          data-aos="fade-up "
        />
        <h1 data-aos="fade-up" data-aos-delay="200" className="text-2xl sm:text-4xl md:5xl lg:text-6xl mt-6 text-center font-bold tracking-wide">
